...
assert(typeof fun === "function", "error: typeof fun is wrong"); // function declaration can be accessed any time
assert(typeof myFunExpr === "undefined", "error: typeof myFunExpr is wrong"); // function expressions and arrow functions cannot..
assert(typeof myArrowExpr === "undefined", "error: typeof myArrowExpr is wrong"); // ... be accessed before they are declared
